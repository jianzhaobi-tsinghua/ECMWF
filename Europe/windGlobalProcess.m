...
%% Select nc files
dirname_sfc_in=['/home/bijianzhao/bjz_tmp/Europe/Europe036Daily/sfc/',num2str(year),'/'];
dirname_mdl_in=['/home/bijianzhao/bjz_tmp/Europe/Europe036Daily/mdl/',num2str(year),'/'];
dirname_out=['/home/bijianzhao/bjz_tmp/Europe/Europe036Hourly/',num2str(year),'/'];
sfcfilenames=dir([dirname_sfc_in,'*.nc']);
mdlfilenames=dir([dirname_mdl_in,'*.nc']);
invFileName='/home/bijianzhao/bjz_tmp/Europe/Europe036Daily/inv/invariant.nc';
