...
dirname_in='/public/temp/BJZ/ERA-Interim/Europe036Daily/2015/';
dirname_out='/public/temp/BJZ/ERA-Interim/Europe036Hourly/2015/';
%dirname_in='';
%dirname_out='res/';
...
for file_i=1:length(filenames)
    ...
    filename=[dirname_in,filenames(file_i).name];
    ...
    filename_out={[dirname_out,subname,'_00.nc'],[dirname_out,subname,'_06.nc'],...
        [dirname_out,subname,'_12.nc'],[dirname_out,subname,'_18.nc']};
